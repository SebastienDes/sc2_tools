...
def load_players_standings(csv_filepath):
    ...
    # Check data types for player_id and ept_points
    ...
    # Optionally check that the region is consistent with expected values
    expected_regions = {'Korea', 'Europe', 'Americas'}
